 ...
 */
class Wurfl02Test {
    private static final Logger log = LoggerFactory.getLogger(Wurfl02Test.class);
    /**
    ...
    void testVersion() {
        ...
        Assertions.assertTrue(wurfl.getWURFLUtils().getVersion().startsWith("Root:Stream resource:WURFL API 1.9.1.0"));
    }
    ...
    void testGoogleBrowser() {
        ...
        Assertions.assertEquals("google_chrome", device.getId());
        Assertions.assertEquals("recovery", device.getMatchType().name());
    ...
    void test_10006() {
        ...
        Assertions.assertFalse(info.isSmartphone());
        Assertions.assertFalse(info.isRobot());
        Assertions.assertEquals("UC Browser on Android", info.getCompleteDeviceName());
        Assertions.assertTrue(info.isLargescreen());
        Assertions.assertEquals("Android", info.getAdvertisedDeviceOs());
        Assertions.assertFalse(info.isAndroid());
        Assertions.assertFalse(info.isXhtmlmpPreferred());
        Assertions.assertEquals("UC Browser on Android", info.getDeviceName());
        Assertions.assertTrue(info.isHtmlPreferred());
    ...
    void test_10008() {
        ...
        Assertions.assertFalse(info.isSmartphone());
        Assertions.assertFalse(info.isRobot());
        Assertions.assertEquals("Chrome Mobile on HarmonyOS", info.getCompleteDeviceName());
        Assertions.assertTrue(info.isLargescreen());
        Assertions.assertEquals("HarmonyOS", info.getAdvertisedDeviceOs());
        Assertions.assertFalse(info.isAndroid());
        Assertions.assertFalse(info.isXhtmlmpPreferred());
        Assertions.assertEquals("Chrome Mobile on HarmonyOS", info.getDeviceName());
        Assertions.assertTrue(info.isHtmlPreferred());
        Assertions.assertEquals("120.0.0.0", info.getAdvertisedBrowserVersion());
        Assertions.assertFalse(info.isWindowsPhone());
        Assertions.assertFalse(info.isIos());
    ...
    void test_10010() {
        ...
        Assertions.assertFalse(info.isSmartphone());
        Assertions.assertFalse(info.isRobot());
        Assertions.assertEquals("Chromium on HarmonyOS", info.getCompleteDeviceName());
        Assertions.assertTrue(info.isLargescreen());
        Assertions.assertEquals("HarmonyOS", info.getAdvertisedDeviceOs());
        Assertions.assertFalse(info.isAndroid());
        Assertions.assertFalse(info.isXhtmlmpPreferred());
        Assertions.assertEquals("Chromium on HarmonyOS", info.getDeviceName());
        Assertions.assertTrue(info.isHtmlPreferred());
        Assertions.assertEquals("120.0.0.0", info.getAdvertisedBrowserVersion());
        Assertions.assertFalse(info.isWindowsPhone());
        Assertions.assertFalse(info.isIos());
    ...
    void test_10022() {
        ...
        Assertions.assertFalse(info.isSmartphone());
        Assertions.assertFalse(info.isRobot());
        Assertions.assertEquals("Generic Android 14 Tablet", info.getCompleteDeviceName());
        Assertions.assertTrue(info.isLargescreen());
        Assertions.assertEquals("Android", info.getAdvertisedDeviceOs());
        Assertions.assertTrue(info.isAndroid());
        Assertions.assertFalse(info.isXhtmlmpPreferred());
        Assertions.assertEquals("Generic Android 14 Tablet", info.getDeviceName());
        Assertions.assertTrue(info.isHtmlPreferred());
        Assertions.assertEquals("120.0.0.0", info.getAdvertisedBrowserVersion());
        Assertions.assertFalse(info.isWindowsPhone());
        Assertions.assertFalse(info.isIos());
    ...
    void test_10025() {
        ...
        Assertions.assertFalse(info.isSmartphone());
        Assertions.assertFalse(info.isRobot());
        Assertions.assertEquals("generic web browser", info.getCompleteDeviceName());
        Assertions.assertTrue(info.isLargescreen());
        Assertions.assertEquals("macOS", info.getAdvertisedDeviceOs());
        Assertions.assertFalse(info.isAndroid());
        Assertions.assertFalse(info.isXhtmlmpPreferred());
        Assertions.assertEquals("generic web browser", info.getDeviceName());
        Assertions.assertTrue(info.isHtmlPreferred());
