...
public class AppleNormalizer implements UserAgentNormalizer {
  ...
  private static Matcher a(String paramString, Pattern paramPattern) {
    return (paramString != null && paramPattern != null) ? ((matcher = paramPattern.matcher(paramString)).find() ? matcher : null) : null;
  }
  ...
  public String normalize(String paramString) {
    ...
    String str;
    Matcher matcher1;
    if ((matcher1 = (Matcher)(((str = paramString) != null && pattern != null) ? ((matcher1 = pattern.matcher(str)).matches() ? matcher1 : null) : null)) != null)
