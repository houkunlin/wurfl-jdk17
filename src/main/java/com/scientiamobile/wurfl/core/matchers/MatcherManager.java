...
public final class MatcherManager {
   ...
   private MatcherChain a(WURFLModel var1) {
      ...
      var2.addMatcher(new i(var1));
      var2.addMatcher(new N(var1));
      var2.addMatcher(new m(new UcwebU3Normalizer(), var1));
      var2.addMatcher(new l(new UcwebU2Normalizer(), var1));
      ...
      var2.addMatcher(new ap(var1));
      var2.addMatcher(new aq(this.d, var1));
      var2.addMatcher(new FennecOnAndroidMatcher(var1));
      var2.addMatcher(new k(var1));
      var2.addMatcher(new aj(var1));
      ...
      var2.addMatcher(new am(var1));
      var2.addMatcher(new al(var1));
      var2.addMatcher(new SamsungMatcher(var1));
      var2.addMatcher(new BlackBerryMatcher(var1));
      var2.addMatcher(new j(var1));
      var2.addMatcher(new ah(var1));
      var2.addMatcher(var10);
      var2.addMatcher(var12);
      var2.addMatcher(new DoCoMoMatcher(var1));
      var2.addMatcher(var14);
      var2.addMatcher(new J(this.j, var1));
      var2.addMatcher(new K(var1));
      var2.addMatcher(var20);
      var2.addMatcher(var9);
      var2.addMatcher(new LGMatcher(this.f, var1));
      var2.addMatcher(new P(var1));
      var2.addMatcher(new R(this.g, var1));
      var2.addMatcher(var7);
      var2.addMatcher(new ai(var1));
      var2.addMatcher(new ak(var1));
      ...
      var2.addMatcher(new h(var1));
      var2.addMatcher(new SPVMatcher(var1));
      var2.addMatcher(var13);
      var2.addMatcher(new n(var1));
      var2.addMatcher(new WebOSMatcher(this.k, var1));
      var2.addMatcher(new ao(new OperaMiniNormalizer(), var1));
      var2.addMatcher(new I(var1));
      var2.addMatcher(new L(var1));
