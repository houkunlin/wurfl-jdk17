...
abstract class AbstractA implements A {
  ...
  public AbstractA(WURFLModel paramWURFLModel) {
    LoggerFactory.getLogger("com.scientiamobile.wurfl.core.UNDETECTED_WURFL_DEVICES");
    LoggerFactory.getLogger("com.scientiamobile.wurfl.core.DETECTED_WURFL_DEVICES");
    this.d = null;
  ...
  public AbstractA(UserAgentNormalizer paramUserAgentNormalizer) {
    LoggerFactory.getLogger("com.scientiamobile.wurfl.core.UNDETECTED_WURFL_DEVICES");
    LoggerFactory.getLogger("com.scientiamobile.wurfl.core.DETECTED_WURFL_DEVICES");
    this.d = paramUserAgentNormalizer;
  }

  public AbstractA(UserAgentNormalizer paramUserAgentNormalizer, WURFLModel paramWURFLModel) {
    LoggerFactory.getLogger("com.scientiamobile.wurfl.core.UNDETECTED_WURFL_DEVICES");
    LoggerFactory.getLogger("com.scientiamobile.wurfl.core.DETECTED_WURFL_DEVICES");
    this.d = paramUserAgentNormalizer;
    AbstractA(paramWURFLModel);
