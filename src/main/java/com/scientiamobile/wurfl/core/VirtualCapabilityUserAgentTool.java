...
public final class VirtualCapabilityUserAgentTool {
    private static final LazyPattern DESKTOP_APP_MAC_PATTERN = new LazyPattern("^Mozilla/[0-9]\\.0 \\(Macintosh;(?: U;)?([a-zA-Z_ \\.0-9]+)(?:;)?.+? DesktopApp ([A-Za-z0-9]+)/([\\d\\.]+)\\.?");
    private static final LazyPattern DESKTOP_APP_WINDOWS_PATTERN = new LazyPattern("^Mozilla/[0-9]\\.0 \\((?:Windows;|X11;)?(?: U; )?([a-zA-Z_ \\.0-9]+)(?:;)?.+? DesktopApp ([A-Za-z0-9]+)/([\\d\\.]+)\\.?");
    private static final LazyPattern ANDROID_VERSION_PATTERN = new LazyPattern("Android(?: |/)([\\d\\.]+).+");
    private static final LazyPattern ADR_ANDROID_VERSION_PATTERN = new LazyPattern(" Adr(?: |/)([\\d\\.]+).+");
    private static final LazyPattern ANDROID_APP_VERSION_PATTERN = new LazyPattern("Android ([\\d\\.]+)");
    private static final LazyPattern FACEBOOK_ANDROID_PATTERN = new LazyPattern("^Mozilla/[45]\\.0.+?Android.+?AppleWebKit.+FB(?:AN/|_IAB/|4A)");
    private static final LazyPattern OPERA_OPR_VERSION_PATTERN = new LazyPattern("OPR/([\\d\\.]+)");
    private static final LazyPattern BROWSER_360_OS_PATTERN = new LazyPattern("^Mozilla\\/[0-9]\\.0 .+?((?:Windows|Linux|PPC|Intel) [a-zA-Z0-9 _\\.\\-]+).+(?:360Browser|360SE)");
    private static final LazyPattern CHROMIUM_VERSION_PATTERN = new LazyPattern("Version\\/.+?Chrome\\/([\\d\\.]+)");
    private static final LazyPattern ANDROID_WEBKIT_VERSION_MARKER_PATTERN = new LazyPattern("Version\\/\\d");
    private static final LazyPattern CHROME_VERSION_PATTERN = new LazyPattern("Chrome\\/([\\d\\.]+)");
    private static final LazyPattern FIREFOX_VERSION_PATTERN = new LazyPattern("(?:Firefox|Fennec)\\/([\\d\\.]+)");
    private static final LazyPattern OPERA_MOBILE_VERSION_PATTERN = new LazyPattern("Opera Mobi\\/.*Version\\/([\\d\\.]+)");
    private static final LazyPattern OPERA_MINI_VERSION_PATTERN = new LazyPattern("Opera Mini\\/([\\d\\.]+)");
    private static final LazyPattern OPERA_TABLET_VERSION_PATTERN = new LazyPattern("Opera Tablet\\/.*Version\\/([\\d\\.]+)");
    private static final LazyPattern UC_BROWSER_VERSION_PATTERN = new LazyPattern("UCBrowser\\/([\\d\\.]+)");
    private static final LazyPattern UC_BROWSER_JUC_VERSION_PATTERN = new LazyPattern("^JUC.*UCWEB([0-9])");
    private static final LazyPattern AMAZON_SILK_VERSION_PATTERN = new LazyPattern(" Silk/([\\d\\.]+)");
    private static final LazyPattern BAIDU_BROWSER_VERSION_PATTERN = new LazyPattern("bdbrowser(?:_i18n)?\\/(\\d+)");
    private static final LazyPattern SAMSUNG_BROWSER_CHROME_VERSION_PATTERN = new LazyPattern("SamsungBrowser/([\\d\\.]+) Chrome/[\\d\\.]+");
    private static final LazyPattern SAMSUNG_BROWSER_VERSION_PATTERN = new LazyPattern("SamsungBrowser/([\\d\\.]+)");
    private static final LazyPattern BAIDU_BROWSER_OS_VERSION_PATTERN = new LazyPattern("^Mozilla\\/[0-9]\\.0 .+?((?:Windows|Linux|PPC|Intel) [a-zA-Z0-9 _\\.\\-]+).+bdbrowser(?:_i18n)?\\/([\\d\\.]+)");
    private static final LazyPattern IOS_CPU_OS_PATTERN = new LazyPattern("Mozilla\\/[45]\\.0 \\((iPhone|iPod|iPod touch|iPad);(?: U;)? CPU(?: iPhone|) OS ([\\d_]+) like Mac OS X");
    private static final LazyPattern IOS_SCALE_PATTERN = new LazyPattern("^[^/]+?/[\\d\\.]+? \\(i[A-Za-z]+; iOS ([\\d\\.]+); Scale/[\\d\\.]+\\)");
    private static final LazyPattern IOS_SERVER_BAG_PATTERN = new LazyPattern("^server-bag \\[iPhone OS,([\\d\\.]+),");
    private static final LazyPattern IOS_DEVICE_PREFIX_VERSION_PATTERN = new LazyPattern("^i(?:Phone|Pad|Pod|Pod touch)\\d+?,\\d+?/([\\d\\.]+)");
    private static final LazyPattern IOS_DEVICE_IOS_VERSION_PATTERN = new LazyPattern("i(?:Phone|Pad|Pod)\\d+?,\\d+? iOS/([\\d_]+)");
    private static final LazyPattern IOS_CHROME_CRIOS_VERSION_PATTERN = new LazyPattern("^Mozilla\\/[45]\\.0.+?like Mac OS X.+?CriOS\\/([\\d\\.]+).+?Mobile\\/[0-9A-Za-z]+ Safari\\/[0-9A-Za-z]+\\.");
    private static final LazyPattern IOS_FIREFOX_FXIOS_VERSION_PATTERN = new LazyPattern("^Mozilla\\/[45]\\.0.+?like Mac OS X.+?FxiOS\\/([\\d\\.]+).+?Mobile\\/[0-9A-Za-z]+ Safari\\/[0-9A-Za-z]+\\.");
    private static final LazyPattern IOS_UC_BROWSER_VERSION_PATTERN = new LazyPattern("^Mozilla\\/[45]\\.0.+?OS \\d_\\d.+?like Mac OS X.+?AppleWebKit.+?.+UCBrowser\\/([\\d\\.]+)");
    private static final LazyPattern IOS_UCWEB_OS_VERSION_PATTERN = new LazyPattern("UCWEB/[\\d\\.]+ \\(iOS;.+?OS ([\\d_]+);.+UCBrowser/");
    private static final LazyPattern IOS_UCWEB_UCBROWSER_VERSION_PATTERN = new LazyPattern("UCWEB/\\d\\.\\d \\(iOS;.+?OS [\\d_]+;.+UCBrowser/([\\d\\.]+)");
    private static final LazyPattern IOS_FACEBOOK_FBAN_PATTERN = new LazyPattern("^Mozilla\\/[45]\\.0.+?like Mac OS X.+?AppleWebKit.+?Mobile\\/[0-9A-Za-z]+.*FBAN");
    private static final LazyPattern IOS_SAFARI_VERSION_PATTERN = new LazyPattern("^Mozilla.+like Mac OS X.+Version/([\\d\\.]+)");
    private static final LazyPattern WINDOWS_PHONE_VERSION_PATTERN = new LazyPattern("Windows Phone(?: OS)? ([\\d\\.]+)");
    private static final LazyPattern WINDOWS_UCWEB_WDS_VERSION_PATTERN = new LazyPattern("UCWEB/\\d\\.\\d \\(Windows;.+?; wds ?([\\d\\.]+?);.+UCBrowser");
    private static final LazyPattern WINDOWS_PHONE_VERSION_SLASH_PATTERN = new LazyPattern("Windows Phone(?: OS)?/([\\d\\.]+)");
    private static final LazyPattern NOKIA_S40_OVI_BROWSER_VERSION_PATTERN = new LazyPattern("\\bS40OviBrowser\\/([\\d\\.]+)");
    private static final LazyPattern SYMBIAN_VERSION_PATTERN = new LazyPattern("(?:SymbianOS|Series60|S60)/([\\d\\.]+)");
    private static final LazyPattern SYMBIAN_UCWEB_S60_MAJOR_VERSION_PATTERN = new LazyPattern("UCWEB/\\d\\.\\d \\(Symbian;.+?S60 V(\\d+)");
    private static final LazyPattern SYMBIAN3_PATTERN = new LazyPattern("^Mozilla\\/[45]\\.0 \\(Symbian\\/3");
    private static final LazyPattern NOKIA_BROWSER_VERSION_PATTERN = new LazyPattern("NokiaBrowser\\/([\\d\\.]+)");
    private static final LazyPattern OPERA_MOBI_VERSION_PATTERN = new LazyPattern("Opera Mobi.+Version\\/([\\d\\.]+)");
    private static final LazyPattern SYMBIAN_UCWEB_UCBROWSER_VERSION_PATTERN = new LazyPattern("UCWEB/[\\d\\.]+ \\(Symbian;.+?UCBrowser/([\\d\\.]+)");
    private static final LazyPattern BLACKBERRY_PATTERN = new LazyPattern("(?:BlackBerry)|(?:^Mozilla\\/5.0 \\(BB10; )");
    private static final LazyPattern BLACKBERRY_UC_BROWSER_PATTERN = new LazyPattern("^BlackBerry[0-9A-Za-z]+?\\/([\\d\\.]+).+?UC Browser\\/?([\\d\\.]+)");
    private static final LazyPattern UCWEB_UCBROWSER_COMBINED_VERSION_PATTERN = new LazyPattern("^UCWEB\\/[0-9]\\.0.+?; [a-zA-Z][a-zA-Z]?\\-[a-zA-Z]?[a-zA-Z]; [0-9]+?\\/([\\d\\.]+).+?UCBrowser\\/?([\\d\\.]+)");
    private static final LazyPattern BLACKBERRY_VERSION_PATTERN = new LazyPattern("^BlackBerry[0-9A-Za-z]+?\\/([\\d\\.]+)");
    private static final LazyPattern BLACKBERRY_BROWSER_VERSION_PATTERN = new LazyPattern("^Mozilla\\/[45]\\.0 \\(BlackBerry;(?: U;)? BlackBerry.+?Version\\/([\\d\\.]+)");
    private static final LazyPattern BB10_BROWSER_VERSION_PATTERN = new LazyPattern("^Mozilla/[45]\\.0 \\(BB10; .+?Version/([\\d\\.]+)");
    private static final LazyPattern RIM_TABLET_OS_VERSION_PATTERN = new LazyPattern("RIM Tablet OS ([\\d\\.]+).+?Version\\/([\\d\\.]+)");
    private static final LazyPattern NETFRONT_VERSION_PATTERN = new LazyPattern("NetFront\\/([\\d\\.]+)");
    private static final LazyPattern OBIGO_Q_VERSION_PATTERN = new LazyPattern("Obig[a-zA-Z]+?\\/(Q[0-9\\.ABC]+)");
    private static final LazyPattern BADA_DOLFIN_PATTERN = new LazyPattern("SAMSUNG.+?\\bBada\\/([\\d\\.]+);?.+Dolfin\\/([\\d\\.]+)");
    private static final LazyPattern OPENWAVE_BROWSER_VERSION_PATTERN = new LazyPattern("UP\\.(?:Browser|Link)\\/([\\d\\.]+)");
    private static final LazyPattern WEBOS_VERSION_PATTERN = new LazyPattern("^Mozilla\\/[45]\\.0 \\((?:Linux; )?webOS\\/([\\d\\.]+)");
    private static final LazyPattern OPERA_MINI_PATTERN = new LazyPattern("Opera Mini\\/([\\d\\.]+)");
    private static final LazyPattern OPERA_LINK_SYNC_VERSION_PATTERN = new LazyPattern("Browser\\/Opera Sync\\/SyncClient.+?Version\\/([\\d\\.]+)");
    private static final LazyPattern IOS_OPERA_OPIOS_VERSION_PATTERN = new LazyPattern("^Mozilla\\/[45]\\.0.+?like Mac OS X.+?OPiOS\\/([\\d\\.]+).+?Mobile\\/[0-9A-Za-z]+ Safari\\/[0-9A-Za-z]+\\.");
    private static final LazyPattern MAEMO_FIREFOX_VERSION_PATTERN = new LazyPattern("Maemo.+?Firefox\\/([0-9a\\.]+) ");
    private static final LazyPattern JAVA_APPLET_PATTERN = new LazyPattern("(?:MIDP.+?CLDC)|(?:UNTRUSTED)|(?:MIDP-2.0)");
    private static final LazyPattern MSIE_WINDOWS_VERSION_PATTERN = new LazyPattern("^Mozilla\\/[0-9]\\.0 \\(compatible; MSIE ([\\d\\.a-z]+); ((?:Windows NT [0-9]+\\.[0-9])|(?:Windows [0-9]\\.[0-9])|(?:Windows [0-9]+)|(?:Mac_PowerPC))");
    private static final LazyPattern EDGE_WINDOWS_VERSION_PATTERN = new LazyPattern("^Mozilla/[45]\\.0 \\((Windows NT [\\d\\.]+).+? Edge/([\\d\\.]+)");
    private static final LazyPattern TRIDENT_WINDOWS_RV_VERSION_PATTERN = new LazyPattern("^Mozilla/[45]\\.0 \\((Windows NT [\\d\\.]+);.+Trident.+; rv:([\\d\\.]+)");
    private static final LazyPattern YANDEX_BROWSER_VERSION_PATTERN = new LazyPattern("^Mozilla\\/[45]\\.[0-9] \\((?:Macintosh; )?([a-zA-Z0-9\\._ ]+).+\\) AppleWebKit.+YaBrowser\\/([\\d\\.]+)");
    private static final LazyPattern CHROME_MAC_VERSION_PATTERN = new LazyPattern("^Mozilla\\/[0-9]\\.0 \\(Macintosh;(?: U;)?([a-zA-Z_ \\.0-9]+)(?:;)?.+? Chrome\\/([\\d\\.]+)\\.?");
    private static final LazyPattern CHROME_WINDOWS_VERSION_PATTERN = new LazyPattern("^Mozilla\\/[0-9]\\.0 \\((?:Windows;|X11;)?(?: U; )?([a-zA-Z_ \\.0-9]+)(?:;)?.+? Chrome\\/([\\d\\.]+)\\.?");
    private static final LazyPattern SAFARI_DESKTOP_VERSION_PATTERN = new LazyPattern("Mozilla\\/[0-9]\\.0 \\((?:Windows|Macintosh); (?:U; |WOW64; )?([a-zA-Z_ \\.0-9]+)(?:;)?[^)]+ Version\\/([\\d\\.]+)\\.?");
    private static final LazyPattern FIREFOX_WINDOWS_VERSION_PATTERN = new LazyPattern("^Mozilla\\/[0-9]\\.0 .+(Windows [0-9A-Za-z \\.]+;).+?rv:.+?Firefox\\/([\\d\\.]+)");
    private static final LazyPattern FIREFOX_LINUX_MAC_VERSION_PATTERN = new LazyPattern("^Mozilla\\/[0-9]\\.0 \\((?:X11|Macintosh); (?:U; |Ubuntu; |)((?:Intel|PPC|Linux) [a-zA-Z0-9\\- \\._\\(\\)]+);.+?rv:.+?Firefox\\/([\\d\\.]+)");
    private static final LazyPattern OPERA_OPR_DESKTOP_VERSION_PATTERN = new LazyPattern("^Mozilla\\/[0-9]\\.0 .+?((?:Windows|Linux|PPC|Intel) [a-zA-Z0-9 _\\.\\-]+).+Chrome\\/.+OPR\\/([\\d\\.]+)");
    private static final LazyPattern OPERA_CLASSIC_VERSION_PATTERN = new LazyPattern("^Opera\\/([\\d\\.]+) .+?((?:Windows|Linux|PPC|Intel) [a-zA-Z0-9 _\\.\\-]+) ?;");
    private static final LazyPattern OPERA_VERSION_PATTERN = new LazyPattern("^Opera\\/.+? Version\\/([\\d\\.]+)");
    private static final LazyPattern IE_MOBILE_VERSION_PATTERN = new LazyPattern("IEMobile\\/([\\d\\.]+)");
    private static final LazyPattern EDGE_VERSION_PATTERN = new LazyPattern("Edge\\/([\\d\\.]+)");
    private static final LazyPattern UCWEB_JAVA_UCBROWSER_VERSION_PATTERN = new LazyPattern("UCWEB/\\d\\.\\d \\(Java;.+?UCBrowser/([\\d\\.]+)");
    private static final LazyPattern PALEMOON_WINDOWS_VERSION_PATTERN = new LazyPattern("^Mozilla\\/[0-9]\\.0 .+(Windows [0-9A-Za-z \\.]+;).+?rv:.+?PaleMoon\\/([\\d\\.]+)");
    private static final LazyPattern PALEMOON_LINUX_MAC_VERSION_PATTERN = new LazyPattern("^Mozilla\\/[0-9]\\.0 \\((?:X11|Macintosh); (?:U; |Ubuntu; |)((?:Intel|PPC|Linux) [a-zA-Z0-9\\- \\._\\(\\)]+);.+?rv:.+?PaleMoon\\/([\\d\\.]+)");
    private static final LazyPattern MOBILE_APP_NAME_VERSION_PATTERN = new LazyPattern("MobileApp ([A-Za-z0-9 ]+)/([\\d\\.]+)");
    private static final LazyPattern ANDROID_MOBILE_APP_NAME_VERSION_PATTERN = new LazyPattern("^Mozilla/[45]\\.0.+?Android.+?AppleWebKit.+MobileApp ([A-Za-z0-9 ]+)/([\\d\\.]+)");
    private static final LazyPattern IOS_MOBILE_APP_NAME_VERSION_PATTERN = new LazyPattern("^Mozilla/[45]\\.0.+?like Mac OS X.+?AppleWebKit.+?Mobile/[0-9A-Za-z]+.*MobileApp ([A-Za-z0-9 ]+)/([\\d\\.]+)");
    private static final LazyPattern AMAZON_ANDROID_VERSION_PATTERN = new LazyPattern(":::Android_(\\d\\.\\d)");
    private static final LazyPattern AMAZON_SHOPPING_ANDROID_VERSION_PATTERN = new LazyPattern("^mShop:::Amazon_Android_([\\d\\.]+):::");
    private static final LazyPattern FIREFOX_SIMPLE_VERSION_PATTERN = new LazyPattern("Firefox/([\\d\\.]+)");
    private static final LazyPattern APPLE_WEBKIT_VERSION_PATTERN = new LazyPattern("AppleWebKit/([\\d\\.]+)");
    private static final LazyPattern IOS_GOOGLE_SEARCH_APP_GSA_VERSION_PATTERN = new LazyPattern("^Mozilla/[45]\\.0.+?like Mac OS X.+?AppleWebKit.+?GSA/([\\d\\.]+) Mobile/");
    private static final LazyPattern NINTENDO_NETFRONT_NX_VERSION_PATTERN = new LazyPattern("Version/([\\d\\.A-Z]+)");
    private static final LazyPattern NINTENDO_NETFRONT_NX_VERSION_PATTERN_2 = new LazyPattern(" NX/([\\d\\.]+)");
    private static final LazyPattern NINTENDO_BROWSER_VERSION_PATTERN = new LazyPattern("NintendoBrowser/([\\d\\.A-Z]+)");
    private static final LazyPattern EPIPHANY_VERSION_PATTERN = new LazyPattern("Epiphany/([\\d\\.]+)");
    private static final LazyPattern TIZEN_VERSION_PATTERN = new LazyPattern("Tizen ([\\d\\.]+)");
    private static final LazyPattern EDGE_ANDROID_VERSION_PATTERN = new LazyPattern("EdgA/([\\d\\.]+)");
    private static final LazyPattern EDGE_IOS_VERSION_PATTERN = new LazyPattern("EdgiOS/([\\d\\.]+)");
    private static final LazyPattern QQ_BROWSER_PATTERN = new LazyPattern("MQQBrowser/([\\d\\.]+)");
    private static final LazyPattern QQ_BROWSER_DESKTOP_PATTERN = new LazyPattern("QQBrowser/([\\d\\.]+)");
    private static final LazyPattern QQ_IOS_BUILTIN_VERSION_PATTERN = new LazyPattern("QQ/([\\d\\.]+)");
    private static final LazyPattern WECHAT_PATTERN = new LazyPattern("MicroMessenger/([\\d\\.]+)");
    private static final LazyPattern SOGOU_MOBILE_PATTERN = new LazyPattern("SogouMobileBrowser/([\\d\\.]+)");
    private static final LazyPattern QUARK_PATTERN = new LazyPattern("Quark/([\\d\\.]+)");
    private static final LazyPattern BRAVE_PATTERN = new LazyPattern("Brave Chrome/([\\d\\.]+)");
    private static final LazyPattern ALIPAY_PATTERN = new LazyPattern("AliApp\\(AP/([\\d\\.]+)");
    private static final LazyPattern FIREFOX_FOCUS_VERSION_PATTERN = new LazyPattern("Focus/([\\d\\.]+)");
    private static final LazyPattern IOS_FIREFOX_FOCUS_VERSION_PATTERN = new LazyPattern("^Mozilla/[45]\\.0.+?like Mac OS X.+?Focus/([\\d\\.]+) Mobile\\/[0-9A-Za-z]+");
    private static final LazyPattern HEYTAP_BROWSER_PATTERN = new LazyPattern("HeyTapBrowser/([\\d\\.]+)");
